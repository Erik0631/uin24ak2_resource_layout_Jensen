...
// Hent informasjon om den valgte ressursen
...
infoBox.innerHTML = `
    ...
    <div class="info-content">
        ...
        <ul>
            ${selectedResource.sources.map(source => `<li><strong>${source.title}:</strong> <a href="${source.url}" target="_blank">${source.url}</a></li>`).join('')}
        </ul>
    </div>
`
